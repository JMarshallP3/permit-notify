...
Based on Texas Railroad Commission W-1 Search Results.
"""
...
class Permit(Base):
    ...
    # RRC W-1 Search Results fields (matching the image columns)
    status_date = Column(Date, nullable=True, index=True)  # Status Date
    status_no = Column(String(50), unique=True, nullable=False, index=True)  # Status # (primary identifier)

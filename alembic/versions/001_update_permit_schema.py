"""Update permit schema to match RRC W-1 Search Results

Revision ID: 001_update_permit_schema
Revises: 
Create Date: 2025-09-22 20:30:00.000000
...
revision = '001_update_permit_schema'
down_revision = None
branch_labels = None
depends_on = None
...
def upgrade():
    """Upgrade database schema to match RRC W-1 Search Results."""

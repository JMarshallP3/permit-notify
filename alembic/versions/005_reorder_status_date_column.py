"""Reorder status_date column to be after id in permits table

Revision ID: 005_reorder_status_date
Revises: 004_remove_well_name_and_field
Create Date: 2025-01-23 19:35:00.000000
...
revision = '005_reorder_status_date'
down_revision = '004_remove_well_name_and_field'
branch_labels = None
depends_on = None


def upgrade():
    """Reorder status_date column to be after id."""
    ...
    op.execute("""
        INSERT INTO permits_new (
            id, status_date, permit_no, operator, county, district, lease_no,
            submission_date, api_no, created_at, status_no, operator_name,
